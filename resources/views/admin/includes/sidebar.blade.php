    ...
    <div class="nk-sidebar-element nk-sidebar-head">
        <div class="nk-sidebar-brand">
            <a href="html/index.html" class="logo-link nk-sidebar-logo">
                <img class="logo-light logo-img" src="./assets/admin/images/logo.png"
                    srcset="./assets/admin/images/logo2x.png 2x" alt="logo">
                <img class="logo-dark logo-img" src="./assets/admin/images/logo-dark.png"
                    srcset="./assets/admin/images/logo-dark2x.png 2x" alt="logo-dark">
                <img class="logo-small logo-img logo-img-small" src="./assets/admin/images/logo-small.png"
                    srcset="./assets/admin/images/logo-small2x.png 2x" alt="logo-small">
            </a>
        </div>
                        ...
                        <ul class="nk-menu-sub">
                            ...
                            <li class="nk-menu-item">
                                <a href="html/components/elements/placeholders.html" class="nk-menu-link"><span
                                        class="nk-menu-text">Placeholders</span>
                                    <span class="nk-menu-badge">New</span></a>
                            </li>
                            <li class="nk-menu-item">
                            ...
                            <li class="nk-menu-item">
                                ...
                                <ul class="nk-menu-sub">
                                    ...
                                    <li class="nk-menu-item"><a
                                            ...
                                            class="nk-menu-link"><span class="nk-menu-text">Two Factor
                                                Auth</span></a></li>
                        ...
                        <ul class="nk-menu-sub">
                            ...
                            <li class="nk-menu-item">
                                <a href="html/components/widgets/ratings.html" class="nk-menu-link"><span
                                        class="nk-menu-text">Ratings Widgets</span></a>
                            </li><!-- .nk-menu-item -->
                        </ul><!-- .nk-menu-sub -->
                    </li><!-- .nk-menu-item -->
                    <li class="nk-menu-item has-sub">
