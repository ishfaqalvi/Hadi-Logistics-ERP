                ...
                <div class="card h-100">
                    <div class="card-inner">
                        ...
                        <ul class="nk-top-products">
                            ...
                            <li class="item">
                                <div class="thumb">
                                    <img src="./assets/admin/images/product/b.png" alt="">
                                </div>
                                <div class="info">
                            ...
                            <li class="item">
                                <div class="thumb">
                                    <img src="./assets/admin/images/product/c.png" alt="">
                                </div>
                                <div class="info">
                            ...
                            <li class="item">
                                <div class="thumb">
                                    <img src="./assets/admin/images/product/d.png" alt="">
                                </div>
                                <div class="info">
                            ...
                            <li class="item">
                                <div class="thumb">
                                    <img src="./assets/admin/images/product/e.png" alt="">
                                </div>
                                <div class="info">
