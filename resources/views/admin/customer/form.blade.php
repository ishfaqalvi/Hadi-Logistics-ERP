<div class="row">
    ...
    <div class="form-group col-lg-6 mb-3">
        ...
        {{ Form::text('father_name', $customer->father_name, ['class' => 'form-control' . ($errors->has('father_name') ? ' is-invalid' : ''), 'placeholder' => 'Father Name','required']) }}
    ...
    <div class="form-group col-lg-4 mb-3">
        {{ Form::label('cnic') }}
        {{ Form::text('cnic', $customer->cnic, ['class' => 'form-control' . ($errors->has('cnic') ? ' is-invalid' : ''), 'placeholder' => 'Cnic','required']) }}
        {!! $errors->first('cnic', '<div class="invalid-feedback">:message</div>') !!}
    </div>
    <div class="form-group col-lg-12 mb-3">
        {{ Form::label('address') }}
        {{ Form::textarea('address', $customer->address, ['class' => 'form-control' . ($errors->has('address') ? ' is-invalid' : ''), 'placeholder' => 'Address', 'rows' => '1']) }}
